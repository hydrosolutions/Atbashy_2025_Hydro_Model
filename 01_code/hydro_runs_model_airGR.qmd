...
calibration_results <- adaptive_lhs_calibration(
  ...
  n_initial_samples = 500,    # Number of initial samples
  n_iterations = 300,          # Number of refinement iterations
  refinement_factor = 0.2,   # Top 20% used for refinement
  n_refined_samples = 30,    # Samples per refinement
  parallel = TRUE           # Set to TRUE for parallel processing
)
...
plot_parameter_uncertainty(
  calibration_results,
  n_best = 10,                 # Use top 10 parameter sets
  inputsModel = inputsModel,
  runOptions = runOptions_cal,

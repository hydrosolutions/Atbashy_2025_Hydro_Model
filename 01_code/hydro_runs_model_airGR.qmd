...
plot_data <- plot_data %>%
  mutate(discharge_m3s = discharge_mm_day * Basin_Info$BasinArea_m2 / (1000 * 86400))
...
p <- ggplot(filtered_data, aes(x = date, y = discharge_m3s)) +
  ...
  labs(
    ...
    caption = "Source: airGR hydrological model simulation"
  ) +

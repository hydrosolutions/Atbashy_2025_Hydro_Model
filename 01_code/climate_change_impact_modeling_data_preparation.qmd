...
We will use airGR for hydrological modeling. Hannah's paper on Atbashy has data analyzed from 2017 - 2024 Let us extract the data for the glacier runoff.
...
q_glac_2000_2024_hist_obs <- q_glac_2000_2024 |> 
  group_by(date) |> 
  summarise(
...
# Create enhanced plot
pl <- ggplot(q_glac_2000_2024_hist_obs, aes(x = date, y = Glacier)) +
...
# Save the data
write_csv(q_glac_2000_2024_hist_obs, 
          file = file.path(glacier_path, "q_glac_2000_2024_hist_obs.csv"))
```
